...
const Token = process.env.REACT_APP_X_RAPIDAPI_KEY_TEXT_TRANSLATOR2_BY_DICKYAGUSTIN;
...
// returning jsx
  ...
  return (
    <div className='mt-[2rem] pt-[1rem] border-2 border-slate-200 p-[2rem] w-[50rem]  m-auto rounded-md flex flex-col gap-[1rem] text-[1.2rem] text-slate-200 '>
      <h1 className=' text-[3rem] text-slate-50 flex gap-[1rem] justify-center items-center'>
        <i className="fa-duotone fa-language"></i>
        <span className='text-[2rem] font-semibold smallCaps'>Universal Language Translator WebApp</span>
      </h1>
